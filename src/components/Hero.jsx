    ...
    return (
        ...
        >
            <div
                ...
                role="img"
                aria-label="Background image of profile picture"
            ></div>
            <img
                src="profile-picture.jpeg"
                alt="Profile picture of Bruno Belloso"
                className="relative w-80 h-80 rounded-full border-4 border-white shadow-lg object-cover"
            />
            ...
            <p className="mt-2 text-lg text-black relative">
                I am a programmer and systems administrator in development. Passionate about new technologies and challenges.
            </p>
        </div>
    );
};
